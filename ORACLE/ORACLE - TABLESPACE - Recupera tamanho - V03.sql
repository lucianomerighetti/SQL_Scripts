...
select vw.tablespace_name,
       ...
       vw.block_size,
       vw.contents,
       to_char(vw.size_gb,'999G999G990','nls_numeric_characters=,.')               size_gb,
       to_char(vw.used_gb,'999G999G990','nls_numeric_characters=,.')               used_gb,
       to_char(vw.free_gb,'999G999G990','nls_numeric_characters=,.')               free_gb,
       to_char(vw.pct_free,'990D00','nls_numeric_characters=,.')                   pct_free,
       to_char(vw.maxsize_gb,'999G999G990','nls_numeric_characters=,.')            maxsize_gb,
       to_char(vw.hwm_gb,'999G999G990','nls_numeric_characters=,.')                hwm_gb,
       to_char((vw.size_gb - vw.hwm_gb),'999G999G990','nls_numeric_characters=,.') reduce_gb
  from (
