...
(
    ...
    CONSTRAINT RECOVERY_FINANCIAL_MOVEMENT_PK PRIMARY KEY (COD_RECOVERY_FINANCIAL_MOVEMENT) USING INDEX TABLESPACE TSIDEBITSCHEDULE01 INITRANS 12,
...
COMMENT ON COLUMN DEBITSCHEDULE_ADM.RECOVERY_FINANCIAL_MOVEMENT.COD_RECOVERY_FINANCIAL_MOVEMENT  IS '[NOT_SECURITY_APPLY] [PK] Codigo de recuperacao de movimentacao financeira';
...
ALTER TABLE DEBITSCHEDULE_ADM.RECOVERY_FINANCIAL_MOVEMENT ADD CONSTRAINT RECY_FIN_MOV_PERCRECOV_FK FOREIGN KEY (IDT_PERCENTUAL_RECOVERY)
